...
var chunk_MKGT35J3_exports = {};
__export(chunk_MKGT35J3_exports, {
...
module.exports = __toCommonJS(chunk_MKGT35J3_exports);
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        const data = import_chunk_4NFKDFT4.prismaSchemaWasm.get_config(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
