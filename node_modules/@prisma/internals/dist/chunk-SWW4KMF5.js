...
var chunk_SWW4KMF5_exports = {};
__export(chunk_SWW4KMF5_exports, {
...
module.exports = __toCommonJS(chunk_SWW4KMF5_exports);
...
var import_chunk_MKGT35J3 = require("./chunk-MKGT35J3.js");
var import_chunk_Y4FY36L7 = require("./chunk-Y4FY36L7.js");
var import_chunk_XBQVGIHJ = require("./chunk-XBQVGIHJ.js");
var import_chunk_CO6L3PWM = require("./chunk-CO6L3PWM.js");
...
async function formatSchema({ schemas }, inputFormattingOptions) {
  ...
  const { formattedMultipleSchemas, lintDiagnostics } = handleFormatPanic(() => {
    ...
    const lintDiagnostics2 = (0, import_chunk_XBQVGIHJ.lintSchema)({ schemas: formattedMultipleSchemas2 });
    return { formattedMultipleSchemas: formattedMultipleSchemas2, lintDiagnostics: lintDiagnostics2 };
  });
  const lintWarnings = (0, import_chunk_XBQVGIHJ.getLintWarningsAsText)(lintDiagnostics);
...
function formatWasm(schema, documentFormattingParams) {
  const formattedSchema = import_chunk_4NFKDFT4.prismaSchemaWasm.format(schema, JSON.stringify(documentFormattingParams));
...
async function processSchemaResult({
  ...
  const configFromPsl = await (0, import_chunk_MKGT35J3.getConfig)({ datamodel: schemaResult.schemas, ignoreEnvVarErrors });
...
async function getGenerators(options) {
  ...
  const dmmf = await (0, import_chunk_Y4FY36L7.getDMMF)({
...
You need to define \`output\` in the generator block in the schema file.`
        ...
        const datamodel = (0, import_chunk_CO6L3PWM.mergeSchemas)({ schemas: schemaContext.schemaFiles });
    ...
    for (const generator of generators) {
      if (generator.manifest && generator.manifest.requiresEngines) {
        ...
        if (engineVersion !== version && generator.options && generator.manifest.requiresEngines.includes(queryEngineType) && generatorBinaryPaths[queryEngineType] && generatorBinaryPaths[queryEngineType]?.[binaryTarget]) {
          const customDmmf = await (0, import_chunk_Y4FY36L7.getDMMF)({
            datamodel: schemaContext.schemaFiles,
            previewFeatures
          });
...
function checkUnsupportedDataProxy({
  ...
  const url = (0, import_chunk_MKGT35J3.resolveUrl)((0, import_chunk_MKGT35J3.getEffectiveUrl)(schemaContext2.primaryDatasource));
